...
import { CloudIcon, StarIcon } from "lucide-react"
      ...
      <Button
        ...
        style={{
          ...
          border: theme === "dark" ? "5px solid #353535" : "5px solid #ececec",
	        boxShadow: 
            theme === "dark"
            // ? "-7px -7px 15px rgba(255, 255, 255, 0.12), 7px 7px 15px rgba(70, 70, 70, 0.65), inset -7px -7px 15px rgba(255, 255, 255, 0.12), inset 7px 7px 15px rgba(70, 70, 70, 0.65)"
            ? "none"
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow:
              theme === "dark"
              // ? "-7px -7px 15px rgba(70, 70, 70, 0.75), 7px 7px 15px rgba(255, 255, 255, 0.12)"
              ? "none"
