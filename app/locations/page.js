      ...
      <section className="bg-[#ff6432]">
        <div id="locations-heading" className="relative block max-w-2xl px-4 py-16 mx-auto sm:px-6 sm:py-24 lg:max-w-[100rem] lg:px-8 lg:py-32">
          <h1 className="lg:text-6xl font-agrandir-bold text-[#171616]">
            ...
            <span className="relative text-[#fee5e1] leading-tight lowercase font-editorial-new underline decoration-wavy decoration-[#171616] underline-offset-8">
              four convenient locations
            </span>{" "}
            or opt for a{" "}
            <span className="relative text-[#fee5e1] leading-tight lowercase font-editorial-new decoration-wavy underline-offset-8 decoration-[#171616] underline">virtual consultation</span>
          </h1>
          <svg className="absolute bottom-0 translate-y-1/2 left-0 translate-x-64 w-36 h-36 text-white rotate-[120deg]" viewBox="0 0 77 85" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="max-w-2xl px-4 py-16 mx-auto sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
              ...
              >
                <button
                  ...
                  } self-end transition-all duration-300 ease-linear w-max  hover:text-secondary-50 mr-6 mb-6`}
