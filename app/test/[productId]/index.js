...
import SingleProductCarousel from "@/app/products/[productId]/SingleProductCarousel"
...
export default function ProductComponent({ product }) {
  ...
  const pages = [
    { name: 'Products', href: '/test', current: false },
    { name: product.name, href: `/test/${product.id}`, current: true },
  ]
  ...
  return (
    <div className="max-w-2xl py-24 mx-auto lg:max-w-7xl">
      ...
      <section className="grid w-full grid-cols-1 px-10 space-y-10 md:space-y-0 md:px-0 md:grid-cols-2 md:gap-12 lg:px-6">
        {product && (
          <>
